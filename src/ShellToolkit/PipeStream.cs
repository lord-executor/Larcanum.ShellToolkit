...
/// <summary>
/// This class is a copy of https://github.com/sshnet/SSH.NET/blob/develop/src/Renci.SshNet/Common/PipeStream.cs with
/// some minor modifications / cleanup because we don't support anything older than .NET 10.
///
...
public class PipeStream : Stream
{
    ...
    private ArrayBuffer _buffer = new(1024);
